...
$teacher_name=$_SESSION['usernamefc'];
$previous_password=$_SESSION['passwordfc'];
...
<body>
<div>
<center><form METHOD="POST" ACTION="change_password_teacher.php">
...
$prev_password=$_SESSION['passwordfc'];
...
$sql = "update teacher_tbl set password='$password1' where name='$teacher_name'";
